...
func (s *sUser) Privacy(ctx context.Context) (*model.UserPrivacyRes, error) {
	...
	return &model.UserPrivacyRes{
		Privacy:    common.NormalizeUserPrivacy(user.Privacy, config.Cfg.Log.Privacy),
		LogPrivacy: config.Cfg.Log.Privacy,
	}, nil
}
...
func (s *sUser) UpdatePrivacy(ctx context.Context, params model.UserPrivacyReq) error {
	...
	if params.UserPrivacy == nil {
		params.UserPrivacy = common.DefaultUserPrivacy()
	}
	params.UserPrivacy.IsConfigured = true
