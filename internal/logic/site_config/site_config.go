...
func (s *sSiteConfig) Create(ctx context.Context, params model.SiteConfigCreateReq) error {
	...
	siteConfig := &do.SiteConfig{
		...
		InviteRewardQuota:                 common.ConvQuotaUnit(params.InviteRewardQuota),
		InviteeGrantQuota:                 common.ConvQuotaUnit(params.InviteeGrantQuota),
		InviteMinApplyQuota:               common.ConvQuotaUnit(params.InviteMinApplyQuota),
		InviteDailyLimit:                  params.InviteDailyLimit,
		InviteTotalLimit:                  params.InviteTotalLimit,
		InviteIpDailyLimit:                params.InviteIpDailyLimit,
		InviteIpTotalLimit:                params.InviteIpTotalLimit,
		InviteIpPerInviterLimit:           params.InviteIpPerInviterLimit,
		InviteIpLimitAction:               params.InviteIpLimitAction,
		InviteRuleText:                    params.InviteRuleText,
		InviteInvalidCodeAction:           params.InviteInvalidCodeAction,
		InviteRechargeRebateEnabled:       params.InviteRechargeRebateEnabled,
		InviteRechargeRebateFirstEnabled:  params.InviteRechargeRebateFirstEnabled,
		InviteRechargeRebateFirstType:     params.InviteRechargeRebateFirstType,
		InviteRechargeRebateFirstRate:     params.InviteRechargeRebateFirstRate,
		InviteRechargeRebateFirstQuota:    common.ConvQuotaUnit(params.InviteRechargeRebateFirstQuota),
		InviteRechargeRebateSecondEnabled: params.InviteRechargeRebateSecondEnabled,
		InviteRechargeRebateSecondType:    params.InviteRechargeRebateSecondType,
		InviteRechargeRebateSecondRate:    params.InviteRechargeRebateSecondRate,
		InviteRechargeRebateSecondQuota:   common.ConvQuotaUnit(params.InviteRechargeRebateSecondQuota),
...
func (s *sSiteConfig) Detail(ctx context.Context, params model.SiteConfigDetailReq) (*model.SiteConfig, error) {
	...
	return &model.SiteConfig{
		...
		InviteRewardQuota:                 common.ConvQuotaUnitReverse(siteConfig.InviteRewardQuota),
		InviteeGrantQuota:                 common.ConvQuotaUnitReverse(siteConfig.InviteeGrantQuota),
		InviteMinApplyQuota:               common.ConvQuotaUnitReverse(siteConfig.InviteMinApplyQuota),
		InviteDailyLimit:                  siteConfig.InviteDailyLimit,
		InviteTotalLimit:                  siteConfig.InviteTotalLimit,
		InviteIpDailyLimit:                siteConfig.InviteIpDailyLimit,
		InviteIpTotalLimit:                siteConfig.InviteIpTotalLimit,
		InviteIpPerInviterLimit:           siteConfig.InviteIpPerInviterLimit,
		InviteIpLimitAction:               siteConfig.InviteIpLimitAction,
		InviteRuleText:                    siteConfig.InviteRuleText,
		InviteInvalidCodeAction:           siteConfig.InviteInvalidCodeAction,
		InviteRechargeRebateEnabled:       siteConfig.InviteRechargeRebateEnabled,
		InviteRechargeRebateFirstEnabled:  siteConfig.InviteRechargeRebateFirstEnabled,
		InviteRechargeRebateFirstType:     siteConfig.InviteRechargeRebateFirstType,
		InviteRechargeRebateFirstRate:     siteConfig.InviteRechargeRebateFirstRate,
		InviteRechargeRebateFirstQuota:    common.ConvQuotaUnitReverse(siteConfig.InviteRechargeRebateFirstQuota),
		InviteRechargeRebateSecondEnabled: siteConfig.InviteRechargeRebateSecondEnabled,
		InviteRechargeRebateSecondType:    siteConfig.InviteRechargeRebateSecondType,
		InviteRechargeRebateSecondRate:    siteConfig.InviteRechargeRebateSecondRate,
		InviteRechargeRebateSecondQuota:   common.ConvQuotaUnitReverse(siteConfig.InviteRechargeRebateSecondQuota),
