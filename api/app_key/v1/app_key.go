...
type ChangeStatusReq struct {
	g.Meta `path:"/change/status" method:"post" auth:"true" role:"user,reseller,admin" tags:"app_key" summary:"更改应用密钥状态接口"`
...
type BatchOperateReq struct {
	g.Meta `path:"/batch/operate" method:"post" auth:"true" role:"user,reseller,admin" tags:"app_key" summary:"应用密钥批量操作接口"`
