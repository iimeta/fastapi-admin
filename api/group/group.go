...
type IGroupV1 interface {
	...
	ChangeExpire(ctx context.Context, req *v1.ChangeExpireReq) (res *v1.ChangeExpireRes, err error)
	ChangePublic(ctx context.Context, req *v1.ChangePublicReq) (res *v1.ChangePublicRes, err error)
