function a(o){var t;const l=o.match(/viewBox="([^"]+)"/),e=o.match(/<svg[^>]*>([\s\S]*)<\/svg>/);return{kind:"svg",viewBox:(l==null?void 0:l[1])||"0 0 64 64",markup:((t=e==null?void 0:e[1])==null?void 0:t.trim())||""}}function r(o,l,e="#ffffff",t=22){return a(`
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
      <rect width="64" height="64" rx="16" fill="${l}" />
      <text
        x="32"
        y="36"
        text-anchor="middle"
...
`),b=r("K","#4F46E5","#FFFFFF",28),P=r("DB","#3370FF","#FFFFFF",20),y=a(`
  <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
`),B=[{aliases:["openai","chatgpt","gpt","codex"],color:"#111111",logo:{kind:"svg",viewBox:"0 0 24 24",path:"M22.282 9.821a5.985 5.985 0 0 0-.516-4.91 6.046 6.046 0 0 0-6.51-2.9A6.065 6.065 0 0 0 4.981 4.18a5.985 5.985 0 0 0-3.998 2.9 6.046 6.046 0 0 0 .743 7.097 5.98 5.98 0 0 0 .51 4.911 6.051 6.051 0 0 0 6.515 2.9A5.985 5.985 0 0 0 13.26 24a6.056 6.056 0 0 0 5.772-4.206 5.99 5.99 0 0 0 3.997-2.9 6.056 6.056 0 0 0-.747-7.073zM13.26 22.43a4.476 4.476 0 0 1-2.876-1.04l.141-.081 4.779-2.758a.795.795 0 0 0 .392-.681v-6.737l2.02 1.168a.071.071 0 0 1 .038.052v5.583a4.504 4.504 0 0 1-4.494 4.494zM3.6 18.304a4.47 4.47 0 0 1-.535-3.014l.142.085 4.783 2.759a.771.771 0 0 0 .78 0l5.843-3.369v2.332a.08.08 0 0 1-.033.062L9.74 19.95a4.5 4.5 0 0 1-6.14-1.646zM2.34 7.896a4.485 4.485 0 0 1 2.366-1.973V11.6a.766.766 0 0 0 .388.676l5.815 3.355-2.02 1.168a.076.076 0 0 1-.071 0l-4.83-2.786A4.504 4.504 0 0 1 2.34 7.872zm16.597 3.855l-5.833-3.387L15.119 7.2a.076.076 0 0 1 .071 0l4.83 2.791a4.494 4.494 0 0 1-.676 8.105v-5.678a.79.79 0 0 0-.407-.667zm2.01-3.023l-.141-.085-4.774-2.782a.776.776 0 0 0-.785 0L9.409 9.23V6.897a.066.066 0 0 1 .028-.061l4.83-2.787a4.5 4.5 0 0 1 6.68 4.66zm-12.64 4.135l-2.02-1.164a.08.08 0 0 1-.038-.057V6.075a4.5 4.5 0 0 1 7.375-3.453l-.142.08L8.704 5.46a.795.795 0 0 0-.393.681zm1.097-2.365l2.602-1.5 2.607 1.5v2.999l-2.597 1.5-2.607-1.5z",color:"#111111"}},{aliases:["anthropic"],color:"#d97757",logo:c},{aliases:["claude","cc"],color:"#d97757",logo:c},{aliases:["gemini","gcpgemini"],color:"#4285f4",logo:n},{aliases:["google"],color:"#4285f4",logo:n},{aliases:["deepseek","deep-seek","deepseek-ai","deepseek baidu","deepseek-baidu"],color:"#4d6bfe",logo:p},{aliases:["wenxin","\u6587\u5FC3","ernie","erniebot","ernie bot"],color:"#2d41ff",logo:g},{aliases:["baidu","qianfan","wenxinyiyan","wenxin yiyan","\u6587\u5FC3\u4E00\u8A00"],color:"#2d41ff",logo:g},{aliases:["azure","azure openai","azureopenai","az"],color:"#0078d4",logo:M},{aliases:["meta","llama"],color:"#0082fb",logo:f},{aliases:["mistral"],color:"#ff7000",logo:u},{aliases:["aliyun","alibaba","alibabacloud","dashscope","tongyi","qwen","\u963F\u91CC\u4E91","\u901A\u4E49"],color:"#ff6a00",logo:d},{aliases:["tencent","hunyuan","\u817E\u8BAF","\u6DF7\u5143"],color:"#0052d9",logo:v},{aliases:["minimax"],color:"#ff4d4f",logo:w},{aliases:["zhipu","zhipuai","zhipu ai","bigmodel","z.ai","\u667A\u8C31","\u667A\u8C31AI"],color:"#3478f6",logo:m},{aliases:["glm","glm-4","chatglm","\u667A\u8C31\u6E05\u8A00"],color:"#3485ff",logo:V},{aliases:["xunfei","xfyun","spark","\u8BAF\u98DE","\u661F\u706B"],color:"#00a9ff",logo:z},{aliases:["openrouter"],color:"#6f4cff",logo:x},{aliases:["cohere","command","command-r","command-r-plus"],color:"#39594d",logo:L},{aliases:["together","togetherai","together ai"],color:"#7c3aed",logo:F},{aliases:["groq"],color:"#f55036"},{aliases:["perplexity","pplx"],color:"#20b8a6"},{aliases:["replicate"],color:"#111111"},{aliases:["sambanova","samba nova","sambanova ai"],color:"#e11d48"},{aliases:["01ai","01.ai","yi","yi-large","yi-lightning","\u96F6\u4E00\u4E07\u7269"],color:"#0f766e"},{aliases:["stepfun","step","step-1","step-2","\u9636\u8DC3","\u9636\u8DC3\u661F\u8FB0"],color:"#2563eb"},{aliases:["baichuan","baichuan-ai","baichuan2","baichuan4","\u767E\u5DDD","\u767E\u5DDD\u667A\u80FD"],color:"#2563eb"},{aliases:["sensetime","sensenova","sensechat","\u65E5\u65E5\u65B0","\u5546\u6C64"],color:"#ef4444"},{aliases:["x","xai","grok"],color:"#111111",logo:C},{aliases:["moonshot","kimi","\u6708\u4E4B\u6697\u9762"],color:"#4f46e5",logo:b},{aliases:["doubao","\u8C46\u5305"],color:"#3370ff",logo:P},{aliases:["volcengine","\u706B\u5C71\u5F15\u64CE"],color:"#ff6b3d",logo:y},{aliases:["\u667A\u5143","FastAPI"],color:"#993D92",logo:A}],h=["#6366f1","#8b5cf6","#ec4899","#14b8a6","#f59e0b","#06b6d4"];function E(o,l){return`${o||""} ${l||""}`.trim().toLowerCase()}function D(o,l,e){const t=E(l,e);return o.find(s=>s.aliases.some(i=>t.includes(i.toLowerCase())))}const q=[{aliases:["openai","chatgpt"],color:"#10a37f",logo:B[0].logo},{aliases:["anthropic"],color:"#d97757",logo:Z},{aliases:["claude"],color:"#d97757",logo:c},{aliases:["google","gemini","gcpgemini"],color:"#4285f4",logo:H},{aliases:["deepseek","deep-seek","deepseek-ai","deepseek baidu","deepseek-baidu"],color:"#4d6bfe",logo:p},{aliases:["baidu","qianfan","wenxin","wenxinyiyan","wenxin yiyan","ernie","erniebot","ernie bot","\u6587\u5FC3","\u6587\u5FC3\u4E00\u8A00"],color:"#2d41ff",logo:G},{aliases:["azure","azure openai","azureopenai"],color:"#0078d4",logo:M},{aliases:["meta","llama"],color:"#0082fb",logo:f},{aliases:["mistral"],color:"#ff7000",logo:u},{aliases:["tencent","hunyuan","\u817E\u8BAF","\u6DF7\u5143"],color:"#0052d9",logo:v},{aliases:["minimax"],color:"#ff4d4f",logo:w},{aliases:["zhipu","zhipuai","zhipu ai","bigmodel","z.ai","\u667A\u8C31","\u667A\u8C31AI"],color:"#3478f6",logo:m},{aliases:["xunfei","xfyun","\u8BAF\u98DE","\u79D1\u5927\u8BAF\u98DE"],color:"#00a9ff",logo:z},{aliases:["openrouter"],color:"#6f4cff",logo:x},{aliases:["cohere"],color:"#39594d",logo:L},{aliases:["together","togetherai","together ai"],color:"#7c3aed",logo:F},{aliases:["groq"],color:"#f55036"},{aliases:["perplexity","pplx"],color:"#20b8a6"},{aliases:["replicate"],color:"#111111"},{aliases:["sambanova","samba nova","sambanova ai"],color:"#e11d48"},{aliases:["01ai","01.ai","\u96F6\u4E00\u4E07\u7269"],color:"#0f766e"},{aliases:["stepfun","\u9636\u8DC3","\u9636\u8DC3\u661F\u8FB0"],color:"#2563eb"},{aliases:["baichuan","baichuan-ai","\u767E\u5DDD","\u767E\u5DDD\u667A\u80FD"],color:"#2563eb"},{aliases:["sensetime","sensenova","\u5546\u6C64"],color:"#ef4444"},{aliases:["x","xai","grok"],color:"#111111",logo:C},{aliases:["moonshot","kimi","\u6708\u4E4B\u6697\u9762"],color:"#4f46e5",logo:b},{aliases:["volcengine","\u706B\u5C71\u5F15\u64CE"],color:"#ff6b3d",logo:y},{aliases:["aliyun","alibaba","alibabacloud","dashscope","tongyi","qwen","\u963F\u91CC\u4E91","\u901A\u4E49"],color:"#ff6a00",logo:d},{aliases:["\u667A\u5143","FastAPI"],color:"#993D92",logo:A}];function k(o,l){return D(B,o,l)}function U(o,l){return D(q,o,l)}function S(o,l){var e;return((e=k(o,l))==null?void 0:e.logo)||null}function _(o,l){const e=k(o,l);if(e)return e.color;const t=E(o,l);let s=0;for(let i=0;i<t.length;i+=1)s=t.charCodeAt(i)+(s*31-s);return h[Math.abs(s)%h.length]}function $(o){return o?o.charAt(0).toUpperCase():"?"}function I(o,l){var e;return((e=U(o,l))==null?void 0:e.logo)||null}export{I as a,_ as b,$ as c,S as g};
